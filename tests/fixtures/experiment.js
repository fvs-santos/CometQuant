function completeGel(overrides = {}) {
  return {
    blindCode: 'ABCD-01', treatment: 'Control', treatmentIndex: 0, gelNumber: 1,
...
function experiment(overrides = {}) {
  return {
    schemaVersion: 3, id: 'exp-1', createdAt: '2026-01-01T00:00:00.000Z', updatedAt: '2026-01-02T00:00:00.000Z',
    ...
    replicates: [{
      ...
      assignments: [{ blindCode: 'ABCD-01', treatmentIndex: 0, gelNumber: 1, status: 'counted', recordedAt: '2026-01-02T00:00:00.000Z' }],
      gels: [completeGel()]
    }],
    ...overrides
  }
